                ...
                @csrf
                    <div class="row" id="form-exit">
                        ...
                        <p id="sentmsg" class="confirm">
                            <span class="glyphicon glyphicon-ok" aria-hidden="true"><svg
                                    xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" width="70" viewBox="0 0 20 20"
                                    fill="currentColor">
                        ...
                        <div class="col-md-12">
                            <textarea type="textbox" id="message" name="message" class="form-field"
